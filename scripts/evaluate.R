...
for (sce in scenarios) {
  ...
  # plot5a/b
  algorithms <- c("Corman-AdjList-2-lessRandom", "Kahn1962-AdjList-3-lessRandom","Corman-AdjList-2-moreRandom", "Kahn1962-AdjList-3-moreRandom")
